...
//             <button
//               onClick={handlePrev}
//               className="absolute left-0 sm:left-2 top-1/2 -translate-y-1/2 z-20 bg-white rounded-full p-2 sm:p-2.5 shadow-lg hover:shadow-xl transition-shadow"
//               aria-label="Previous service"
//             >
//               <ChevronLeft className="w-4 h-4 sm:w-5 sm:h-5 text-gray-700" />
//             </button>
...
//             <button
//               onClick={handleNext}
//               className="absolute right-0 sm:right-2 top-1/2 -translate-y-1/2 z-20 bg-white rounded-full p-2 sm:p-2.5 shadow-lg hover:shadow-xl transition-shadow"
//               aria-label="Next service"
//             >
//               <ChevronRight className="w-4 h-4 sm:w-5 sm:h-5 text-gray-700" />
//             </button>
...
//                   <div
//                     key={index}
//                     className="absolute transition-all ease-in-out duration-700 cursor-pointer"
//                     style={{
//                       transform: `
//                         translateX(${translateX}px)
//                         translateZ(${translateZ}px)
...
//                       `,
//                       opacity: opacity,
//                       zIndex: isActive ? 20 : 10 - position,
//                       pointerEvents: isVisible ? "auto" : "none",
//                       display: isVisible ? "block" : "none",
//                     }}
//                     onClick={() => {
...
//                         w-[280px] sm:w-72 lg:w-80 bg-white rounded-2xl shadow-xl overflow-hidden
//                         transition-all duration-300
//                         ${isActive ? "ring-2 ring-offset-2 ring-[#E63946]" : ""}
//                       `}
//                     >
//                       <div
//                         className={`bg-gradient-to-br ${service.gradient} p-5 sm:p-6 text-white relative overflow-hidden`}
    ...
    <div id="services" className="bg-gray-50 py-8 sm:py-12 px-4 sm:px-6">
      <div className="max-w-6xl mx-auto">
        <div className="bg-white rounded-2xl shadow-sm p-4 sm:p-6 lg:p-8 mb-8">
          ...
          {/* Desktop Grid Section */}
          <div
            className="hidden lg:block mt-12 pt-8 border-t border-gray-100"
            data-aos="fade-up"
            data-aos-delay="300"
          >
            <div className="grid grid-cols-4 gap-4">
