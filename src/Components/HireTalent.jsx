      ...
      <div className="flex-1 flex flex-col bg-white">
        ...
        <div className="relative h-[400px] sm:h-[500px] md:h-[600px] flex items-center justify-center overflow-hidden">
          ...
          <div 
            ...
            style={{
              backgroundImage: 'url(https://static.wixstatic.com/media/11062b_6743da5900054f1f8e69f53302930a6af000.jpg/v1/fill/w_980,h_400,al_c,q_85,usm_0.33_1.00_0.00,enc_avif,quality_auto/11062b_6743da5900054f1f8e69f53302930a6af000.jpg)',
          ...
          >
            ...
            <div className="absolute inset-0" style={{ backgroundColor: '#164d61', opacity: 0.75 }}></div>
          </div>
          ...
          <div 
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-4 sm:mb-6" style={{ fontFamily: 'futura-lt-w01-book, sans-serif', letterSpacing: '0.05em' }}>
              FIND TALENT
            </h1>
            <p className="text-lg sm:text-xl md:text-2xl text-white italic px-4" style={{ fontFamily: 'Georgia, serif' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-start">
              ...
              >
                <p className="text-sm sm:text-base md:text-lg text-gray-900 leading-relaxed text-justify">
                  From tiny startups to international conglomerates, one of the age-old challenges in business is building a winning team. With shifting demographics, varying skill levels, and different motivations, it is increasingly difficult to identify and cater to today's labor pool.
                </p>
                ...
                <p className="text-sm sm:text-base md:text-lg text-gray-900 leading-relaxed text-justify">
                  But like anything in business, there are tactics and strategies that increase your chances of success in acquiring top talent. we will help you discover what works best for your team.
                </p>
              </div>
              ...
              >
                ...
                {/* Decorative Line */}
                <div className="w-full max-w-xs sm:max-w-md h-px mb-8 sm:mb-10 md:mb-12" style={{ background: 'linear-gradient(to right, transparent, #164d61, transparent)' }}></div>
                ...
                <button 
                  ...
                  style={{ background: 'linear-gradient(135deg, #162461ff 0%, #E63946 100%)' }}
                >
